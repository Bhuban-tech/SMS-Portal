  ...
  return (
    <>
      ...
      >
            ...
            return (
              <Link key={item.id} href={item.path}>
                <button
                  ...
                  className={`flex items-center gap-3 w-full px-4 py-3 rounded-lg transition-all duration-200 whitespace-nowrap ${
                    isActive
        ...
        {/* Settings Button */}
        <div className="mt-auto shrink-0 pt-4 border-t border-slate-700">
